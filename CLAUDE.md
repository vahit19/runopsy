...
**Published on Hugging Face** as `renderfy/runopsy-bench` — the twenty synthetic cases, with a card stating that they are generated rather than recorded and pointing at TRAIL and Who&When for human-labelled real traces. Overstating what that dataset is would cost more than publishing it gains.
